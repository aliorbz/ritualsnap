  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (file.size > 2 * 1024 * 1024) {
        setUploadWarning("Warning: Large sigils (>2MB) may be rejected by the Great Database.");
      }
        ...
        <section className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              {uploadWarning && <p className="text-[10px] text-yellow-600 uppercase tracking-widest animate-pulse">{uploadWarning}</p>}
            </div>
